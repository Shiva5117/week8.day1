...
public class VerifyFindLead extends ProjectSpecificMethods{
	...
	public void verifyfindLead(String username, String password, String fname, String lname, String company, String searchFirstName,
		...
		.clickFindLeads().findLead(searchFirstName).clickFirstLead().ClickEdit(editCompany).verifyCompany(editCompany);
